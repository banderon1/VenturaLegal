...
if( !function_exists('fia_add_attribution_box') )
{
...
if( !function_exists('fia_create_menu') )
{
    add_action('admin_enqueue_scripts', 'fia_create_menu');
...
if( !function_exists('fia_show_attribution_box') )
{
...
if( !function_exists('fia_handle_attribution_data') )
{
...
if( !function_exists('fia_featured_img_attribution') )
{
